  ...
  return (
    <div className="section1">
      <div className="general">
        ...
        <p>
          For our latest pricing, please see our{" "}
          <a href="services/">pricing page</a>. Please note the price quoted is
          per tax return and is a once-off price, NOT a subscription or monthly
          cost. Therefore, in most cases where you only need to file a tax
          return once in a year, then the cost will be one single payment. If
          you are behind in your tax return filings and you need the prior year
          and current year filed, you will need to pay the fee twice (two tax
          returns).
          <br />
          <br />
        ...
        <p>
          ...
          connected to your SARS eFiling profile).
        </p>
        <br />
        <br />
        <p>
          {" "}
          Depending on load, we also help with the dispute resolution /
          objection process if requested (although there will be a fee charged).
        </p>
        ...
        <p>
          ...
          claim, you can reach us on live chat or our helpdesk to ask.
        </p>
        <br />
        <br />
        <p>
          If you notice a problem after you have submitted to SARS, it's easy to
          make a correction on TaxTim and submit a corrected tax return. SARS
          will not get upset with you for making honest mistakes and corrections
          are quite routine.
        </p>
        ...
        <ol>
          ...
          <li>
            An online document storage facility to keep important tax
            certificates safe.
          </li>
          <li>Multiple system checks before submission to SARS.</li>
          <li>
            Online support from expert tax practitioners throughout the process.
          </li>
          <li>
            A "Tax Health Score" report containing personalised recommendations
            on how to become more tax efficient.
          </li>
          <li>
            Tax Expense Tracker app to track expenses throughout the year and
            make end-of-year accounting easy.
          </li>
          <li>Vehicle logbook app to track your work and private car trips.</li>
          <li>
            Assistance with supporting documents submission, if audited by SARS.
          </li>
          <li>
            Assistance with dispute resolution / objection process, if
            applicable. (Note there may be an additional fee charged depending
